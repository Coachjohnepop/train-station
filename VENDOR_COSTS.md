...
| **Stripe** | Membership checkout ($25 / $50 / $850) | **REV-SHARE** + optional 🔴 Connect | Card fees typically **~2.9% + $0.30**/successful charge (US online); Connect/payout extras if used | **$0** fixed; **% of GMV** when Live | Jeremy merchant · John ops | **Code live · often Test mode** |
