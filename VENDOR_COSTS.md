...
**Stripe money note:** Full charge → Jeremy’s master account first. John’s share is **not** a second merchant account and **not** auto-split at checkout — see `STRIPE_COMMISSION_SETUP.md` / `CONTEXT.md` / `JEREMY_ADMIN_MANUAL.md`.
