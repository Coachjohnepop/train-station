...
import { clearWebAuthnForDevice } from "@/lib/quick-auth-store";
...
export async function POST(request: Request) {
  ...
  await clearWebAuthnForDevice(session.email, deviceId);
  return NextResponse.json({ ok: true, webauthn: false });
}