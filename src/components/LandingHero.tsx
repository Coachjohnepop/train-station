      ...
      <div className="relative z-10 flex h-full items-center justify-center px-6">
        <div className="max-w-5xl text-center">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <a 
              href="/member" 
              className="inline-flex h-14 items-center justify-center rounded-full bg-white px-10 text-sm font-bold !text-black transition-all hover:bg-white hover:scale-[1.2] active:scale-[0.985]"
            >
              Start Training
            </a>
            <a 
              href="/admin" 
              className="inline-flex h-14 items-center justify-center rounded-full border border-white/40 px-10 text-sm font-semibold text-white backdrop-blur transition-all hover:bg-white/10 hover:scale-[1.2] active:scale-[0.985]"
            >
              For Coaches
            </a>
          </div>
        ...
        {images.map((_, idx) => (
          <button
            ...
            className={`h-px w-8 transition-all duration-300 ${
              idx === current ? 'bg-white w-12' : 'bg-white/30 hover:bg-white/50'
            }`}
