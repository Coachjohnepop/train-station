...
export default function DayCompleteStamp({
  ...
  return (
    ...
    >
      ...
      <span
        className="relative rotate-[-22deg] select-none border-[2.5px] border-[var(--success)] px-3 py-1.5 text-center text-sm font-black uppercase tracking-[0.18em] text-[var(--success)] shadow-[0_0_0_1px_color-mix(in_srgb,var(--success)_35%,transparent)] sm:px-4 sm:text-base"
        style={{
          textShadow: "0 1px 0 color-mix(in srgb, var(--success) 40%, transparent)",
        }}
      >
        Day Complete
      </span>
