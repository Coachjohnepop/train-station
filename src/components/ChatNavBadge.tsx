...
export default function ChatNavBadge({
  ...
  return (
    <span
      className={
        placement === "corner"
          ? "absolute left-1/2 top-0 z-10 flex h-[20px] min-w-[20px] -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-[#ff3b30] px-1 text-[10px] font-bold leading-none text-white shadow-md ring-2 ring-[var(--bg)]"
