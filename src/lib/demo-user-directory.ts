...
export const DEMO_USER_DIRECTORY: DemoUserEntry[] = [
  { id: "demo-user-john-steph", email: "john@lemonvoice.com", name: "John & Steph", phone: "(555) 111-2235" },
  ...
  { id: "demo-user-stephanie", email: "kaite@thetrainstation.co", name: "Katie", phone: "(555) 111-2234" },
