...
function rowToMemberProfile(
  ...
  return {
    ...
    weightLossGoal: row.weightLossGoal ?? null,
    weightLossTimeline: row.weightLossTimeline ?? null,
    primaryGoal: row.primaryGoal ?? null,
    workoutSchedule: row.workoutSchedule ?? null,
    calorieMin: row.calorieMin ?? null,
    calorieRangeMax: row.calorieRangeMax ?? null,
    calorieHardMax: row.calorieHardMax ?? null,
    notes: row.notes,
    city: user.city,
    state: user.state,
...
function profileToDbFields(profile: MemberProfile) {
  return {
    ...
    weightLossTimeline: profile.weightLossTimeline,
    primaryGoal: profile.primaryGoal,
    workoutSchedule: profile.workoutSchedule,
    calorieMin: profile.calorieMin,
    calorieRangeMax: profile.calorieRangeMax,
    calorieHardMax: profile.calorieHardMax,
    notes: profile.notes,
