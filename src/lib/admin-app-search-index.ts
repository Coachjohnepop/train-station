...
export const ADMIN_APP_SEARCH_INDEX: AdminSearchItem[] = [
  ...
  },
  {
    id: "coach-members",
    title: "Members",
    description: "Roster, member cards, payment status, program position",
    href: "/admin/members",
    workspace: "coach",
    group: "People",
    keywords: [
  ...
  },
  {
    id: "coach-search-seo",
    title: "Search",
    description: "Google, Bing, Safari — titles, sitemap, get thetrainstation.co found",
    href: "/admin/seo",
    workspace: "both",
    group: "Site",
    keywords: [
  ...
  {
    id: "platform-accounting-books",
    title: "Accounting · Books (GL)",
    description: "General ledger, chart of accounts, trial balance",
    href: "/admin/accounting?tab=books",
    workspace: "platform",
    group: "Commerce",
    keywords: [
      "ledger",
  ...
  },
  {
    id: "platform-mercury",
    title: "Mercury",
    description: "Bank balances, registers, cards, recipients",
    href: "/admin/mercury",
    workspace: "platform",
    group: "Commerce",
    keywords: ["mercury", "bank", "checking", "register", "in flight"],
  },
  {
    id: "platform-affiliates",
    title: "Affiliates",
    description: "Affiliate users, payout percent, and Stripe payouts",
    href: "/admin/affiliates",
    workspace: "platform",
    group: "Commerce",
    keywords: ["affiliate", "referral", "commission percent", "payout", "connect"],
  },
  {
    id: "platform-commission",
    title: "Money desk",
    description: "Stripe balance, holding min, payout queue, Connect, platform admin fee",
