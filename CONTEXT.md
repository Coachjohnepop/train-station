...
**Date:** 2026-08-17  
**Status:** Catalog titles repaired across all programs (139 generic `Workout` rows renamed from their exercises). Builder no longer PATCHes names down to `Workout`; clones default to Unassigned / inferred title. Stripe leftover unchanged: confirm webhook 200, revoke **Eco** old `sk_live` (not Jeremy’s), Connect Express for payouts.  
